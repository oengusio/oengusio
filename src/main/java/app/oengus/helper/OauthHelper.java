...
public class OauthHelper {
	...
	public static Map<String, String> buildOauthMapForLogin(final Oauth2Params params, final String code) {
		return buildOauthBase(params, code, params.getRedirectUri());
	}

	public static Map<String, String> buildOauthMapForSync(final Oauth2Params params, final String code) {
		return buildOauthBase(params, code, params.getSyncRedirectUri());
	}

	private static Map<String, String> buildOauthBase(final Oauth2Params params, final String code, final String redirectUri) {
