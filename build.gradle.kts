...
//    implementation(group = "org.springframework.boot", name = "spring-boot-starter-undertow")
    ...
    // JACKSON
    implementation(group = "tools.jackson.core", name = "jackson-core", version = "3.1.2")
    ...
    // documentation
    implementation(group = "org.springdoc", name = "springdoc-openapi-starter-webmvc-api", version = "3.0.2")
    ...
    implementation(group = "com.rabbitmq", name = "amqp-client", version = "5.29.0")
